  ...
  <form class="msform" id="onboarding_form">
    ...
    <fieldset id="step_1">
      ...
      <div class="row js_services js_s1">
        ...
        <div class="col-md-6"><button class="btn btn-2 btn-sep icon-battery js_servicename" data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-car-fields='brand,model,year' data-service-fields='budget' data-fieldset="step_1">Sustitución de la batería</button></div>
        <div class="col-md-3"></div>
      </div>
      ...
      <div class="row js_services js_s3">
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-oil js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='revision_constructor' data-fieldset="step_1">Revisión completa</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-oil js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='change_filter' data-fieldset="step_1">Cambio de aceite</button></div>
      ...
      <div class="row js_services js_s5">
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-brakes js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='brake_pads' data-fieldset="step_1">Pastillas de freno</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-brakes js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='pad_position' data-fieldset="step_1">Discos de freno</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-brakes js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='pad_position' data-fieldset="step_1">Discos y Pastillas</button></div>
      </div>
      ...
      <div class="row js_services js_s7">
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Correa de distribucion</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Kit de distribución</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Bomba inyectora</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='injectors_and_services' data-fieldset="step_1">Inyectores</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Alternador</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Bomba de dirección</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Bomba de agua</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Embrague</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Radiador refrigerante</button></div>
        <div class="col-md-2"></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Termostato</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='spark_plug' data-fieldset="step_1">Bujías</button></div>
        <div class="col-md-2"></div>
      </div>
      ...
      <div class="row js_services js_s9">
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Equilibrado de ruedas</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Alineación paralelo</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='shock_absorber_type' data-fieldset="step_1">Amortiguadores</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='keencap_type' data-fieldset="step_1">Rótulas de suspensión</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='cup_type' data-fieldset="step_1">Copelas de suspensión</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='bearing_assembly' data-fieldset="step_1">Rodamientos</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Bomba de dirección</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Rótulas de dirección</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Vástago de dirección</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Fuelles de dirección</button></div>
        <div class="col-md-4"><button class="btn btn-2 btn-sep icon-car js_servicename" data-car-fields='brand,model,year' data-car-details-fields='vin_number,cilindrata,letras_del_motor' data-service-fields='' data-fieldset="step_1">Cremallera de dirección</button></div>
